...
class VistaCategoria:
    def __init__(self, parent_frame):
        ...
        # Título
        tk.Label(self.frame, text="Administración de Secciones", 
                font=("Georgia", 18, "bold"), fg=ACCENT_COLOR, bg=BG_COLOR).pack(pady=(15, 10), anchor="w", padx=12)
        
        # Frame del formulario
        self.frame_form = tk.LabelFrame(self.frame, text="Categoría", padx=20, pady=15, 
        ...
        self.entry_id.grid(row=0, column=1, padx=6, pady=4, sticky="w")
        ...
        self.entry_desc = tk.Entry(self.frame_form, width=50, state="readonly")
        self.entry_desc.grid(row=2, column=1, padx=6, pady=4)
        ...
        for c in cols:
            ...
            self.tree.column(c, width=240 if c != "id" else 60)
